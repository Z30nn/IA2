                        ...
                        <div class="card text-white bg-flat-color-2">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Faculty</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-3">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Department</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-5">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Student</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-1">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Courses</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-secondary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Comp. Result</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Semester</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-info">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Level</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Distinction No.</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-6">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Upper Credit</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-4">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Lower Credit</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-2">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Passed No.</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-danger">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Failed No.</p><!-- Log on to freeprojectscodes.com for more projects! -->
                                </div><!-- /.card-left -->
